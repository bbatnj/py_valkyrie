...
from valkyrie.ml.net import Filter1D, BatchNormAlongW
...
class SaotomeNetII(ml_modules.Regressor):
  def __init__(self, lr):
    ...
    self.net = nn.Sequential(
      Filter1D(groups=n_c0o, n_out_channel=n_c1o, kernel_size=5, stride=2), BatchNormAlongW(n_c1o * n_instr), LReLU(0.01),
      Filter1D(groups=n_c1o, n_out_channel=n_c2o, kernel_size=5, stride=2), BatchNormAlongW(n_c2o * n_instr), LReLU(0.01),
      Filter1D(groups=n_c2o, n_out_channel=n_c3o, kernel_size=5, stride=2), BatchNormAlongW(n_c3o * n_instr), LReLU(0.01),
      Filter1D(groups=n_c3o, n_out_channel=n_c4o, kernel_size=5, stride=2), BatchNormAlongW(n_c4o * n_instr), LReLU(0.01),
