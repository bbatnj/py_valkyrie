...
class TestApp(TestWrapper, TestClient):
    ...
    def tickByTickOperations_req(self):
        ...
        self.reqTickByTickData(19007, ContractSamples.USStockAtSmart(), "BidAsk", 10, False)
    ...
    def historicalTicksOperations(self):
        # ! [reqhistoricalticks]
        print('hello')
        contract = ContractSamples.USStockAtSmart("T")
        self.reqHistoricalTicks(18001, contract,
                                "20210110 09:30:00", "", 100, "TRADES", 0, True, [])
        self.reqHistoricalTicks(18002, contract,
                                "20210110 09:30:00", "", 100, "BID_ASK", 0, True, [])
